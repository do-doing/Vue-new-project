...
#newsContents .media-title a{
  white-space: normal;
  font-size: 15px;
  color: #3b3b3b;
}

#newsContents .mui-ellipsis {
  position: absolute;
  bottom: 0px;
  font-size: 12px;
  color: #999;
...
#newsContents .mui-table-view-cell:after {
  left: 0;
  background: #e5e5e5;
}
.more-btn {
...
.article .content-title .more-link{
  color: #999;
  line-height: 1.2;
  font-size: 14px;
}
